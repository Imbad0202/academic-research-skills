...
- **揭露模式**（academic-paper v2.9）— 針對特定期刊/會議的 AI 使用聲明生成器。v1 涵蓋 ICLR、NeurIPS、Nature、Science、ACL、EMNLP。（後續擴充：v2 資料庫（#596）新增 9 個醫學 venue — ICMJE、NEJM、The Lancet、JAMA、BMJ、PLOS、Frontiers，以及資料庫首批兩個中文 venue：中華護理雜誌社、國際眼科雜誌。）
