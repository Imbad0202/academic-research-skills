...
- **`quality-boost`** (below-frontier session): judgment-type agents at the Stage 2.5/4.5 gates and final-review surfaces jump UP to the frontier tier (however many tiers away — not a single increment); nothing is ever downgraded. No-op at the frontier (announce once).
