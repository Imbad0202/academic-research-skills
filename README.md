...
Hermes documentation for this fork lives in:

- [`HERMES.md`](HERMES.md)
- [`hermes/README.md`](hermes/README.md)
- [`docs/index.html`](docs/index.html) for GitHub Pages

The original upstream README content is preserved below to keep upstream documentation and repository consistency checks intact.
