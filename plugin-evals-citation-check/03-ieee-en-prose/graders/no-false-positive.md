...
weight: 1
---
Two entries are correct: [1] (Haddad and Ostrowski, 2021) and [6] (Marchetti and Oyelaran, 2021). Their authors, year, title, venue, pages, and DOI match the source pack, and the sentences citing them are supported by the source-pack abstracts. Find every mention of each in the response and quote it.
