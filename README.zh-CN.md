...
- **AI 使用声明模式**（academic-paper v2.9）— 针对特定期刊/会议的 AI 使用声明生成器。v1 涵盖 ICLR、NeurIPS、Nature、Science、ACL、EMNLP。（后续扩充：v2 数据库（#596）新增 9 个医学出版政策目标 — ICMJE、NEJM、The Lancet、JAMA、BMJ、PLOS、Frontiers，以及数据库首批两个中文政策目标：出版社级的中华护理杂志社条目和期刊级的国际眼科杂志条目。）
