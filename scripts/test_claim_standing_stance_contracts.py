...
def test_v1_3_reuses_the_family_excerpt_cache_and_rights_blocks_verbatim():
    v1_0 = _schema("evidence/evidence_row.schema.json")["properties"]
    v1_3 = _schema("evidence/evidence_row_v1_3.schema.json")["properties"]
    for block in ("excerpt", "cache", "content_handling", "row_sha256"):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda r: r["rows"][0].__setitem__("evidence_row_ids", []),
