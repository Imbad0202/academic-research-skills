...
> **Abstract.** … the intervention produced an effect of b = 0.31 on self-efficacy …
>
...
+++ b/manuscript.md
@@ Abstract @@
-… the intervention produced a moderate effect (d = 0.55) on self-efficacy …
+… the intervention produced an effect of b = 0.31 on self-efficacy …
