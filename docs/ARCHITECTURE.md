...
graph TD
    ...
    NR[reviewer-response<br/>companion workflow<br/>v0.1.0]
    ...
    APR -. "real reviewer comments / decision letters" .-> NR
    AP -. "revision package evidence" .-> NR
    DR --- Shared
    AP --- Shared
    APR --- Shared
    NR --- Shared
...
| Skill | Modes |
|---|---|
| `deep-research` v2.10.0 | full, quick, socratic, review, lit-review, fact-check, three-way-scan, systematic-review (8) |
...
| `reviewer-response` v0.1.0 | draft, audit, revise, triage-only, appeal-like (5) |
