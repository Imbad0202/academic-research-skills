...
|---|---|---|
| Integrity verification | Single-model 100% check | + risk-stratified sample (100% of high-impact references + random remainder) independently verified by 2nd model |
