...
- `claim-standing-retrieval-input/1.0`: explicit attempts, retained raw hits, caller-supplied relevance assessments, and a whole-input digest.
...
6. apply the caller-supplied relevance assessment independently of canonical selection, retaining its outcome, raw output and matching digest, rationale, or explicit failure;
